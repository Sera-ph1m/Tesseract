...
Tesseract (previously and in the code named somethingBox) is an online tool for sketching and sharing instrumental music.
You can find it [here](https://github.com/Sera-ph1m/Tesseract/).
It is a modification of [Slarmoosbox](slarmoo.github.io/slarmoosbox), a mod of [Ultrabox](https://ultraabox.github.io), which is a modification of [JummBox](https://github.com/jummbus/jummbox), which inturn is a modification of the [original BeepBox](https://beepbox.co).
...
Tesseract, as well as the beepmods which it's based on, are free projects. If you ever feel so inclined, please support the original creator, [John Nesky](http://www.johnnesky.com/), via
...
```
git clone https://github.com/Sera-ph1m/Tesseract.git
cd Tesseract
npm install
npm run build
```

JummBox (and by extension, Tesseract) makes a divergence from BeepBox that necessitates an additional dependency:
...
The [synth/](synth) folder has just the code you need to be able to play Tesseract
...
Tesseract also has an indirect, optional dependency on
[lamejs](https://www.npmjs.com/package/lamejs) via
[jsdelivr](https://www.jsdelivr.com/) for exporting .mp3 files. If the user
attempts to export an .mp3 file, Tesseract will direct the browser to download
