...
class CustomChipCanvas {
    ...
    public redrawCanvas(): void {
        ...
        const renderColor: string = getPrimaryNoteColor(this._doc, this._doc.channel);
    ...
    */
    ...
    private _renderInstrumentBar(channel: Channel, instrumentIndex: number, colors: ChannelColors) {
        if (this.doc.song.layeredInstruments || this.doc.song.patternInstruments) {
            ...
            this._instrumentsButtonBar.style.setProperty("--background-color-lit", getPrimaryNoteColor(this.doc, this.doc.channel));
            this._instrumentsButtonBar.style.setProperty("--background-color-dim", getSecondaryNoteColor(this.doc, this.doc.channel));
