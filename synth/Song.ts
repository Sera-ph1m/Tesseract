...
import { BitFieldReader, BitFieldWriter, Channel, ChannelTag, ChannelType, CharCode, Config, Dictionary, DictionaryArray, Envelope, EnvelopeType, FilterControlPoint, FilterType, InstrumentType, LegacySettings, Note, NotePin, SongTagCode, Synth, URLDebugger, base64CharCodeToInt, base64IntToCharCode, clamp, convertLegacyKeyToKeyAndOctave, decode32BitNumber, encode32BitNumber, encodeUnisonSettings, makeNotePin, parseFloatWithDefault, parseIntWithDefault, validateRange } from './synth';
import { EffectType, LFOEnvelopeTypes, RandomEnvelopeTypes, SampleLoadedEvent, SampleLoadingState, SampleLoadingStatus, SustainType, effectsIncludeBitcrusher, effectsIncludeChord, effectsIncludeChorus, effectsIncludeDetune, effectsIncludeDiscreteSlide, effectsIncludeDistortion, effectsIncludeEcho, effectsIncludeGranular, effectsIncludeNoteFilter, effectsIncludePanning, effectsIncludePitchShift, effectsIncludeReverb, effectsIncludeRingModulation, effectsIncludeTransition, effectsIncludeVibrato, loadBuiltInSamples, sampleLoadEvents, sampleLoadingState, startLoadingSample, toNameMap } from './SynthConfig';
export class Song {
